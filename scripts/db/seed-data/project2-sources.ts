...
export const project2Config: SeedProjectConfig = {
  projects: [
    {
      ...
      description: 'Bibliography on the evolutionary, psychological, and institutional foundations of human cooperation, welfare state legitimacy, health system design, and species-level macro forces.',
      color: '#7C3AED',
      isStarred: true,
    },
    {
      ...
      description: 'Focused collection on universal health coverage, primary health care declarations, social determinants of health, and resilient health system design.',
      color: '#0891B2',
    },
  ],

  tags: [
    { key: 'cooperation', name: 'Human Cooperation & Altruism', color: '#DC2626', description: 'Evolutionary biology of cooperation, reciprocal altruism, punishment, cultural evolution, and gift economies' },
    { key: 'collective-action', name: 'Collective Action & Social Capital', color: '#2563EB', description: 'Social trust, institutional quality, collective action problems, and civic engagement' },
    { key: 'welfare', name: 'Welfare-State Design & Public Attitudes', color: '#D97706', description: 'Welfare regime typologies, deservingness perceptions, redistribution preferences, and universal vs. targeted programs' },
    { key: 'health', name: 'Health Systems & Healing', color: '#059669', description: 'Universal health coverage, primary health care, social determinants of health, and health system resilience' },
    { key: 'trajectory', name: 'Species Trajectory & Macro Forces', color: '#7C3AED', description: 'Global trends, population projections, climate scenarios, and systemic risk assessments' },
  ],
  ...
  entries: [
    ...
    // ============================================================
    {
      ...
      year: 1964,
      metadata: { doi: '10.1016/0022-5193(64)90038-4', journal: 'Journal of Theoretical Biology', volume: '7', issue: '1', pages: '1-16', publisher: 'Elsevier' },
      isFavorite: true,
      tagKey: 'cooperation',
      customFields: { 'Reading Status': 'completed', 'Priority': 'high' },
      annotation: {
        content: 'Hamilton introduces the concept of "inclusive fitness," formalizing the idea that natural selection can favor altruistic behavior when the benefit to relatives, weighted by their genetic relatedness, exceeds the cost to the altruist (Hamilton\'s rule: rB > C). This paper, along with its companion, provided the first rigorous theoretical explanation for the evolution of cooperation among kin and is one of the most important papers in evolutionary biology.',
        type: 'summary',
      },
      veritasScore: {
        overallScore: 96,
        ...
        label: 'exceptional',
        factors: [
          { name: 'Publisher Reputation', score: 85, weight: 0.15, evidence: 'JTB is a respected theoretical biology journal', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 98, weight: 0.3, evidence: 'Over 10,000 citations; one of the most-cited papers in evolutionary biology', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 95, weight: 0.2, evidence: 'Hamilton is widely regarded as one of the greatest evolutionary theorists of the 20th century', source: 'OpenAlex' },
          { name: 'Methodology', score: 95, weight: 0.2, evidence: 'Rigorous mathematical population genetics framework', source: 'Semantic Scholar' },
          { name: 'Currency', score: 90, weight: 0.15, evidence: 'Published 1964; remains foundational and actively cited', source: 'CrossRef' },
        ],
    ...
    },
    {
      ...
      veritasScore: {
        ...
        label: 'exceptional',
        factors: [
          { name: 'Publisher Reputation', score: 90, weight: 0.15, evidence: 'QRB is the premier review journal in biology', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 97, weight: 0.3, evidence: 'Over 9000 citations; defined reciprocal altruism as a field', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 92, weight: 0.2, evidence: 'Trivers is one of the most influential evolutionary biologists of the 20th century', source: 'OpenAlex' },
          { name: 'Methodology', score: 90, weight: 0.2, evidence: 'Formal evolutionary model with rich empirical examples', source: 'Semantic Scholar' },
          { name: 'Currency', score: 88, weight: 0.15, evidence: 'Published 1971; foundational and still actively cited', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    {
      ...
      authors: [{ firstName: 'Robert', lastName: 'Axelrod' }, { firstName: 'William', middleName: 'D.', lastName: 'Hamilton' }],
      year: 1981,
      metadata: { doi: '10.1126/science.7466396', journal: 'Science', volume: '211', issue: '4489', pages: '1390-1396', publisher: 'American Association for the Advancement of Science' },
      isFavorite: true,
      tagKey: 'cooperation',
      notes: 'Introduced the iterated Prisoner\'s Dilemma tournament showing that Tit-for-Tat—a simple strategy of cooperation and proportional retaliation—outperforms more complex strategies. Foundational for game-theoretic analysis of cooperation.',
      annotation: {
        content: 'Axelrod and Hamilton demonstrate through computer tournaments that cooperation can evolve among self-interested agents in iterated Prisoner\'s Dilemma games. The simple strategy "Tit-for-Tat"—cooperate first, then mirror your partner\'s previous move—proved remarkably robust, winning both tournaments. The paper shows that cooperation emerges not from altruism but from the "shadow of the future": the prospect of repeated interaction makes reciprocity individually rational.',
        type: 'summary',
      },
      veritasScore: {
        overallScore: 95,
        ...
        label: 'exceptional',
        factors: [
          { name: 'Publisher Reputation', score: 97, weight: 0.2, evidence: 'Science is one of the two most prestigious multidisciplinary journals', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 97, weight: 0.25, evidence: 'Over 15,000 citations; one of the most-cited papers in social science', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 92, weight: 0.2, evidence: 'Axelrod is a MacArthur Fellow; Hamilton is a legendary evolutionary theorist', source: 'OpenAlex' },
          { name: 'Methodology', score: 93, weight: 0.2, evidence: 'Novel computational tournament methodology that became a standard research tool', source: 'Semantic Scholar' },
          { name: 'Currency', score: 85, weight: 0.15, evidence: 'Published 1981; continues to be extended and refined', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    {
      ...
      year: 2006,
      metadata: { doi: '10.1126/science.1133755', journal: 'Science', volume: '314', issue: '5805', pages: '1560-1563', publisher: 'AAAS' },
      tagKey: 'cooperation',
      annotation: {
        content: 'Nowak synthesizes decades of theoretical work on cooperation into five unifying mechanisms: kin selection, direct reciprocity, indirect reciprocity (reputation), network reciprocity (spatial structure), and group selection. For each mechanism, he provides the critical condition under which natural selection favors cooperators over defectors. This paper serves as the standard reference for the taxonomy of cooperative mechanisms in evolutionary biology.',
        type: 'summary',
      },
      veritasScore: {
        overallScore: 91,
        ...
        label: 'exceptional',
        factors: [
          { name: 'Publisher Reputation', score: 97, weight: 0.2, evidence: 'Science; top-tier multidisciplinary journal', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 93, weight: 0.25, evidence: 'Over 4000 citations; standard reference for cooperation theory', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 90, weight: 0.2, evidence: 'Nowak directs Harvard\'s Program for Evolutionary Dynamics', source: 'OpenAlex' },
          { name: 'Methodology', score: 88, weight: 0.2, evidence: 'Elegant mathematical synthesis unifying disparate models', source: 'Semantic Scholar' },
          { name: 'Currency', score: 85, weight: 0.15, evidence: 'Published 2006; some debate on group selection mechanism', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    {
      ...
      veritasScore: {
        ...
        factors: [
          ...
          { name: 'Citation Impact', score: 95, weight: 0.25, evidence: 'Over 5000 citations; defined the field of altruistic punishment', source: 'Semantic Scholar' },
          { name: 'Methodology', score: 90, weight: 0.2, evidence: 'Clean experimental design with public goods game and punishment option', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 90, weight: 0.2, evidence: 'Fehr is one of the most-cited behavioral economists in the world', source: 'OpenAlex' },
          { name: 'Currency', score: 82, weight: 0.15, evidence: 'Published 2002; extensively replicated and extended', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    {
      ...
      authors: [{ firstName: 'Ernst', lastName: 'Fehr' }, { firstName: 'Klaus', middleName: 'M.', lastName: 'Schmidt' }],
      year: 1999,
      metadata: { doi: '10.1162/003355399556151', journal: 'Quarterly Journal of Economics', volume: '114', issue: '3', pages: '817-868', publisher: 'MIT Press' },
      tagKey: 'cooperation',
      notes: 'Introduces the inequity aversion model. People dislike outcomes where they get less than others (disadvantageous inequity) or more than others (advantageous inequity). Foundation for behavioral economics of fairness.',
      annotation: {
        content: 'Fehr and Schmidt develop a formal model of "inequity aversion" in which people dislike both disadvantageous and advantageous inequality in outcomes. They show that even a minority of inequity-averse agents can sustain cooperation and punish defectors in environments where purely self-interested agents would defect. The model successfully predicts behavior across a wide range of experimental games and has become a standard tool in behavioral economics.',
        type: 'evaluative',
      },
      veritasScore: {
        overallScore: 93,
        ...
        factors: [
          ...
          { name: 'Citation Impact', score: 96, weight: 0.25, evidence: 'Over 10,000 citations; one of the most-cited papers in behavioral economics', source: 'Semantic Scholar' },
          { name: 'Methodology', score: 90, weight: 0.2, evidence: 'Formal utility model with strong predictive power across games', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 92, weight: 0.2, evidence: 'Fehr at University of Zurich; Schmidt at University of Munich', source: 'OpenAlex' },
          { name: 'Currency', score: 82, weight: 0.15, evidence: 'Published 1999; remains the dominant inequity aversion model', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    {
      ...
      tagKey: 'cooperation',
      annotation: {
        content: 'Based on his Boston Tanner Lectures, Tomasello presents experimental evidence that human children display cooperative, helpful behavior from as early as 14 months—before socialization can fully account for it. He argues that humans possess a unique suite of cognitive and motivational adaptations for shared intentionality, joint attention, and cooperative communication that distinguishes them from other great apes and underlies human culture and institutions.',
        type: 'summary',
      },
    },
    {
      ...
      authors: [{ firstName: 'Samuel', lastName: 'Bowles' }, { firstName: 'Herbert', lastName: 'Gintis' }],
      year: 2011,
      metadata: { publisher: 'Princeton University Press' },
      tagKey: 'cooperation',
      notes: 'Strong empirical case that human cooperation goes far beyond what kin selection or reciprocal altruism can explain. Argues for gene-culture coevolution of "strong reciprocity."',
      annotation: {
        content: 'Bowles and Gintis argue that human cooperation exceeds what kin selection and reciprocal altruism can explain, proposing "strong reciprocity"—a predisposition to cooperate with cooperators and punish defectors even at personal cost. They present evidence from behavioral experiments, ethnographic data, and gene-culture coevolutionary models showing that intergroup competition and cultural institutions amplified prosocial preferences over human evolutionary history.',
        type: 'critical',
      },
    },
    {
      ...
      tagKey: 'cooperation',
      annotation: {
        content: 'Norenzayan argues that belief in morally concerned, omniscient "Big Gods" helped scale human cooperation beyond small kin-based groups to the large anonymous societies of the modern world. Drawing on experimental, anthropological, and historical evidence, he proposes that religious surveillance beliefs served as a cultural mechanism for sustaining prosocial behavior among strangers, though secular institutions can and do substitute for this function in modern democracies.',
        type: 'evaluative',
      },
    },
    {
    ...
    },
    {
      ...
      authors: [{ firstName: 'Joseph', lastName: 'Henrich' }, { firstName: 'Steven', middleName: 'J.', lastName: 'Heine' }, { firstName: 'Ara', lastName: 'Norenzayan' }],
      year: 2010,
      metadata: { journal: 'Behavioral and Brain Sciences', volume: '33', issue: '2-3', pages: '61-83', publisher: 'Cambridge University Press' },
      tagKey: 'cooperation',
      notes: 'WEIRD = Western, Educated, Industrialized, Rich, Democratic. Landmark methodological critique showing that psychology\'s findings are based on a narrow, unrepresentative slice of humanity.',
      annotation: {
        content: 'Henrich, Heine, and Norenzayan demonstrate that the vast majority of behavioral science research draws subjects from "WEIRD" societies (Western, Educated, Industrialized, Rich, Democratic), which represent a narrow and often outlier slice of human psychological diversity. They show that WEIRD subjects are unusual on measures of visual perception, fairness, cooperation, reasoning, and self-concept. The paper is a foundational methodological critique that has reshaped how social scientists think about generalizability.',
        type: 'critical',
      },
      veritasScore: {
        overallScore: 91,
        ...
        label: 'exceptional',
        factors: [
          { name: 'Publisher Reputation', score: 88, weight: 0.15, evidence: 'BBS is a high-impact interdisciplinary journal with open peer commentary', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 97, weight: 0.3, evidence: 'Over 7000 citations; one of the most-cited methodological critiques in social science', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 88, weight: 0.2, evidence: 'Henrich at Harvard; all three are leading cultural psychologists', source: 'OpenAlex' },
          { name: 'Methodology', score: 90, weight: 0.2, evidence: 'Systematic review across multiple domains with cross-cultural data', source: 'Semantic Scholar' },
          { name: 'Currency', score: 88, weight: 0.15, evidence: 'Published 2010; catalyzed major shift toward cross-cultural sampling', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    ...
    },
    {
      ...
      veritasScore: {
        ...
        label: 'exceptional',
        factors: [
          { name: 'Publisher Reputation', score: 98, weight: 0.2, evidence: 'Nature; top-tier multidisciplinary journal', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 93, weight: 0.25, evidence: 'Over 3500 citations; founded the field of spatial evolutionary games', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 90, weight: 0.2, evidence: 'Nowak at Harvard; May was President of the Royal Society and Chief Scientific Adviser to the UK Government', source: 'OpenAlex' },
          { name: 'Methodology', score: 88, weight: 0.2, evidence: 'Elegant computational model with clear analytical results', source: 'Semantic Scholar' },
          { name: 'Currency', score: 82, weight: 0.15, evidence: 'Published 1992; framework extensively developed since', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    ...
    },
    {
      ...
      tagKey: 'collective-action',
      notes: 'Rothstein\'s key theoretical contribution: universal welfare institutions create social trust (not the reverse). Trust is an outcome of institutional design, not a cultural given.',
      annotation: {
        content: 'Rothstein develops a theory of "social traps" in which rational individuals fail to cooperate because they lack confidence that others will do the same, even when mutual cooperation would benefit everyone. He argues that the solution lies in institutional design: universal, impartial government institutions generate social trust by credibly signaling that others are contributing fairly. The book provides the theoretical foundation for his later work on welfare state design and corruption.',
        type: 'summary',
      },
    },
    {
    ...
    },
    {
      ...
      authors: [{ firstName: 'Bo', lastName: 'Rothstein' }, { firstName: 'Eric', middleName: 'M.', lastName: 'Uslaner' }],
      year: 2005,
      metadata: { doi: '10.1353/wp.2006.0022', journal: 'World Politics', volume: '58', issue: '1', pages: '41-72', publisher: 'Cambridge University Press' },
      tagKey: 'collective-action',
      annotation: {
        content: 'Rothstein and Uslaner present a model of a "social trap" in which inequality and corruption mutually reinforce low social trust, creating a vicious cycle. They argue that only universal welfare policies—not targeted programs—can break this cycle by reducing inequality and signaling government impartiality. The paper provides cross-national empirical evidence linking universal social programs to higher trust and lower corruption.',
        type: 'summary',
      },
    },
    {
      ...
      year: 1996,
      metadata: { journal: 'World Politics', volume: '48', issue: '2', pages: '143-179', publisher: 'Cambridge University Press' },
      tagKey: 'collective-action',
      annotation: {
        content: 'Pierson argues that welfare state retrenchment operates under a fundamentally different political logic than welfare state expansion. Because cutting popular programs generates concentrated losses and diffuse gains, politicians pursue strategies of blame avoidance and obfuscation rather than credit claiming. The paper is foundational for understanding why welfare states are resilient and how "path dependency" shapes social policy possibilities.',
        type: 'evaluative',
      },
    },
    {
      ...
      annotation: {
        content: 'Olson demonstrates that rational self-interest alone cannot explain collective action to provide public goods: individuals have incentives to free-ride on others\' contributions, so large groups will under-provide shared benefits unless coercion or selective incentives overcome the free-rider problem. This insight became one of the most important results in political economy, directly motivating Ostrom\'s later work showing how communities actually do solve collective action problems.',
        type: 'reflective',
      },
    },
    ...
    },
    {
      ...
      authors: [{ firstName: 'Alberto', lastName: 'Alesina' }, { firstName: 'Edward', middleName: 'L.', lastName: 'Glaeser' }],
      year: 2004,
    ...
    },
    {
      ...
      tagKey: 'welfare',
      annotation: {
        content: 'Petersen and colleagues use experimental methods to show that deservingness judgments operate as automatic cognitive heuristics rather than deliberated value applications. When people evaluate welfare recipients, they rapidly and intuitively assess cues related to effort, need, and reciprocity, often overriding their stated ideological commitments. This finding has important implications for understanding why welfare attitudes can be so resistant to political messaging.',
        type: 'summary',
      },
    },
    {
      ...
      veritasScore: {
        ...
        label: 'high',
        factors: [
          { name: 'Publisher Reputation', score: 90, weight: 0.2, evidence: 'ASR is the flagship journal of the American Sociological Association', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 92, weight: 0.25, evidence: 'Over 2000 citations; defined the "paradox of redistribution" concept', source: 'Semantic Scholar' },
          { name: 'Methodology', score: 85, weight: 0.2, evidence: 'Cross-national comparative analysis of 18 OECD countries', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 88, weight: 0.2, evidence: 'Korpi and Palme at Stockholm University; pioneers of power resources theory', source: 'OpenAlex' },
          { name: 'Currency', score: 78, weight: 0.15, evidence: 'Published 1998; some later studies debate the paradox under current conditions', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    ...
    },
    {
      ...
      veritasScore: {
        ...
        label: 'high',
        factors: [
          { name: 'Publisher Reputation', score: 95, weight: 0.2, evidence: 'AER is the top general-interest economics journal', source: 'Semantic Scholar' },
          { name: 'Methodology', score: 88, weight: 0.25, evidence: 'Natural experiment exploiting German reunification', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 85, weight: 0.2, evidence: 'Over 1500 citations; key reference on institutions shaping preferences', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 90, weight: 0.2, evidence: 'Alesina at Harvard (one of the most-cited economists); Fuchs-Schündeln at Goethe University', source: 'OpenAlex' },
          { name: 'Currency', score: 80, weight: 0.15, evidence: 'Published 2007; findings confirmed by subsequent research', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    {
      ...
      authors: [{ firstName: 'Alberto', lastName: 'Alesina' }, { firstName: 'Eliana', lastName: 'La Ferrara' }],
      year: 2005,
      metadata: { journal: 'Journal of Public Economics', volume: '89', issue: '5-6', pages: '897-931', publisher: 'Elsevier' },
      tagKey: 'welfare',
      annotation: {
        content: 'Alesina and La Ferrara analyze American attitudes toward redistribution and find that support is lower among those who believe they have good prospects for upward mobility, who believe the economic system is fair, and who are not members of disadvantaged racial or income groups. The paper quantifies the "American exceptionalism" in redistribution preferences and identifies social mobility beliefs as a key mechanism.',
        type: 'evaluative',
      },
    },
    {
    ...
    },
    {
      ...
      authors: [{ firstName: 'Christina', middleName: 'M.', lastName: 'Fong' }, { firstName: 'Samuel', lastName: 'Bowles' }, { firstName: 'Herbert', lastName: 'Gintis' }],
      year: 2006,
      metadata: { publisher: 'Elsevier', container: 'Handbook of the Economics of Giving, Altruism and Reciprocity', volume: '2' },
      tagKey: 'welfare',
      annotation: {
    ...
    {
      entryType: 'report',
      title: 'Corruption, Happiness, Social Trust and the Welfare State: A Causal Mechanisms Approach',
      authors: [{ firstName: 'Bo', lastName: 'Rothstein' }],
      year: 2010,
      metadata: { publisher: 'Quality of Government Institute, University of Gothenburg', series: 'QoG Working Paper' },
      tagKey: 'welfare',
      annotation: {
        content: 'Rothstein proposes a causal model linking welfare state design to happiness through the mechanisms of social trust and corruption perceptions. He argues that universal welfare institutions reduce corruption (by minimizing bureaucratic discretion), which increases trust in government, which in turn increases generalized social trust and well-being. The paper provides the theoretical architecture connecting his earlier institutional analysis to subjective well-being outcomes.',
        type: 'summary',
      },
    },
    {
    ...
    },
    {
      ...
      extraProjectKeys: ['p2-health'],
      annotation: {
        content: 'The 2010 WHO report makes the case for universal health coverage (UHC) as an achievable goal for all countries, regardless of income level. It identifies three dimensions of coverage (population breadth, service depth, cost protection height) and estimates that 20-40% of health spending globally is wasted. The report provided the intellectual framework that led to UHC\'s inclusion as a Sustainable Development Goal target.',
        type: 'evaluative',
      },
    },
    {
    ...
    },
    {
      ...
      year: 2012,
      metadata: { journal: 'Bulletin of the World Health Organization', volume: '90', pages: '867-868', publisher: 'WHO / PMC' },
      tagKey: 'health',
      extraProjectKeys: ['p2-health'],
      annotation: {
        content: 'Kutzin, WHO\'s lead health financing specialist, clarifies that universal health coverage is not merely about insurance enrollment but about ensuring effective access to needed services without financial hardship. He argues against the misconception that "anything goes" in the path to UHC and emphasizes core principles: prepayment over out-of-pocket spending, risk pooling, strategic purchasing, and compulsory rather than voluntary participation.',
        type: 'critical',
      },
    },
    {
    ...
    },
    {
      ...
      veritasScore: {
        ...
        label: 'high',
        factors: [
          { name: 'Publisher Reputation', score: 95, weight: 0.2, evidence: 'The Lancet is one of the world\'s top medical journals', source: 'Semantic Scholar' },
          { name: 'Citation Impact', score: 90, weight: 0.25, evidence: 'Over 1500 citations; influenced WHO and World Bank investment frameworks', source: 'Semantic Scholar' },
          { name: 'Author Credentials', score: 88, weight: 0.2, evidence: 'Jamison led the Disease Control Priorities project; Commission included Nobel laureates', source: 'OpenAlex' },
          { name: 'Methodology', score: 85, weight: 0.2, evidence: 'Comprehensive modeling of health outcomes and economic returns', source: 'Semantic Scholar' },
          { name: 'Currency', score: 82, weight: 0.15, evidence: 'Published 2013; trajectory disrupted by COVID-19 but framework remains valid', source: 'CrossRef' },
        ],
        dataSources: ['Semantic Scholar', 'CrossRef', 'OpenAlex'],
      },
    },
    ...
    },
    {
      ...
      authors: [],
      year: 2018,
      metadata: { publisher: 'World Health Organization', url: 'https://www.who.int/docs/default-source/primary-health/declaration/gcphc-declaration.pdf' },
      tagKey: 'health',
      extraProjectKeys: ['p2-health'],
      annotation: {
        content: 'The Astana Declaration renewed the global commitment to primary health care 40 years after Alma-Ata, updating the PHC vision for the 21st century. It emphasizes primary care as the foundation for achieving universal health coverage and the SDGs, and highlights digital health, multisectoral action, and community empowerment. The declaration signaled a renewed political commitment to PHC-centered health system design.',
        type: 'summary',
      },
    },
    {
